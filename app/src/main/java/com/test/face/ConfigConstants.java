...
public class ConfigConstants {
    ...
    private static final String IMAGE_PIPELINE_SMALL_CACHE_DIR = "zhidian/pic/cache/small";//小图所放路径的文件夹名
    private static final String IMAGE_PIPELINE_CACHE_DIR = "zhidian/pic/cache";//默认图所放路径的文件夹名
